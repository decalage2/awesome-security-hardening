...
- [oudenOS](https://github.com/redpersongpt/oudenOS) - Open source Windows optimizer that blocks 70 telemetry endpoints, disables unnecessary services, and hardens privacy settings with per-action rollback
